...
final List<Menu> listMenu = [
  Menu(
    ...
    isFavorite: true,
    category: 'Deals',
    description: 'Gurihnya mentega yang dipadu dengan segarnya kopi, pilihan terbaik untuk menu di pagi hari.',
  ),
  Menu(
    id: 02,
  ...
  Menu(
    ...
    isFavorite: false,
    category: 'Deals',
    description: 'Combo coffee bun dan melonpan sangat cocok bagi pecinta manis',
  ),
  Menu(
    id: 10,
    name: 'Pizza Bomb',
...
List<Menu> get listItem => listMenu;